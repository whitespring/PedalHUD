...
final class RideOverlayCameraStreamSource: NSObject, CMIOExtensionStreamSource {
    ...
    func startStream() throws {
        guard let deviceSource = device.source as? RideOverlayCameraDeviceSource else {
